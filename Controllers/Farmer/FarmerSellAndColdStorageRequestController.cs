...
namespace Fair_Farm.Controllers.Farmer
{
    public class FarmerSellAndColdStorageRequestController : ApiController
    {
        ...
        /*[FarmerAccess]*/
        [HttpPost]
        [Route("api/farmersellandcoldstoragerequest/create")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmerRequestTableDatabyUserIdandsingleResendData/{userid}")]
        ...
        /*[FarmerAccess]*/
        [HttpPut]
        [Route("api/farmersellandcoldstoragerequestupupdate/{userid}")]
        ...
        /*[FarmerAccess]*/
        [HttpDelete]
        [Route("api/farmersellandcoldstoragerequestdelete/{id1}/{userid}")]
        ...
        /*[Logged]*/
        [HttpGet]
        [Route("api/farmerrequesttabledatabyuseridandspecifictype/{userid}/{type}")]
