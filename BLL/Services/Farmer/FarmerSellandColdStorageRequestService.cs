...
{
    public class FarmerSellandColdStorageRequestService
    {
        public static RequestTableDTO Add(RequestTableDTO s)
        {
            ...
            var addedData = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Create(data);
        ...
        {
            var checkrequest = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Getexists(id1, userid);
            ...
            return FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Delete(id1);
        }
        ...
        public static RequestTableDTO Update(RequestTableDTO dt, int userid)
        {
            ...
            var checkrequest = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Getexists(requesttableid, userid);
            var checkuser = DataAccessFactory.UserData().Get(userid);
            if(data==null)
            {
                throw new Exception("Invalid Request Type.");
            ...
            var updatedData = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Update(data);
            var config2 = new MapperConfiguration(cfg =>
            {
                cfg.CreateMap<RequestTable, RequestTableDTO>();
            });
        ...
        {
            var data = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().Getexists(id, userid);
        ...
        {
            var data = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().GetByType(userid, type);
        ...
        {
            var data = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().GetSinle(id);
        ...
        {
            var data = FarmerDataAccessFactory.FarmersellandColdStorageRequestData().GetSinlebyUserId(userid);
